...
if __name__ == '__main__':
    ...
    parser.add_argument('--case', required=True, choices=['atari', 'classic_control', 'box2d', 'scheduling'],
    ...
    ray.init(num_cpus=int(16 * 1.0) + 5, num_gpus=2)
    # Process arguments
    ...
    muzero_config = ScheudlingControlConfig('Muzero_scheduling_game/src/environment/env_config_real_data.yml')
